...
public class principal_test {
	...
	public static void main(String[] args) {
		...
		Persona persona1 = new Persona("nomb1", "apell1");
		DAOPersona.create( persona1 );
		Persona persona2 = new Persona("nomb2", "apell2");
		DAOPersona.create( persona2 );
		Persona persona3 = DAOPersona.find(2);
		System.out.println( persona3.getNombre() );
		persona3.setNombre("TodayTest3");
		DAOPersona.update( persona3 );
		System.out.println( "Id generado y agregado a la instancia:" +  persona1.getId() );
		DAOPersona.delete( persona1 );
